...
<body>
    ...
    <div class="header-to-bar"> HELLO EVERYONE! 25% Off All Products (Use Coupon: "MHP") </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                ...
                                <p class="about-text">{{ settings('footer_text') }}
                                ...
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            ...
                                            <li class="li"><a class="single-link" href="{{ route('blog') }}">Blogs</a>
                                            </li>
                                            <li class="li"><a class="single-link" href="{{ route('cart') }}">Cart</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-6 mb-lm-30px pl-lg-50px">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    <div class="footer-row">
                                        <ul class="align-items-center">
                                            <li class="li"><a class="single-link" href="{{ route('index') }}">Jesco</a>
                                            </li>
                                            <li class="li"><a class="single-link" href="{{ route('customer') }}">Log in</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    <!-- News letter area -->
                                    <p class="address">{{ settings('author_address') }}</p>
                                    <p class="phone">Phone: {{ settings('phone_number') }}</a></p>
                                    <p class="mail">Email: {{ settings('auth_email') }}</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <p class="copy-text"> © {{ \Carbon\Carbon::now()->format('Y') }} <strong>Jesco</strong> Made With <i class="fa fa-heart" aria-hidden="true"></i> By <a target="_blank"class="company-name" href="https://facebook.com/mokarom.pranto2"><strong> {{ settings('author_name') }}</strong></a>.</p>
                        </div>
                    </div>
                </div>
            </div>
