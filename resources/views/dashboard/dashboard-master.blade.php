                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
							<li><a href="{{ route('settings.add') }}">Add Settings</a></li>
							<li><a href="{{ route('settings.change') }}">Change Settings</a></li>
						</ul>
                    </li>
                    <li>
                        <a class="has-arrow ai-icon" href="{{ route('category.create') }}" aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow ai-icon" href="{{ route('post.create') }}" aria-expanded="false">
							<i class="fa fa-file-text"></i>
							<span class="nav-text">Post</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="{{ route('post.create') }}">Post Add</a></li>
                    ...
                    <li><a href="{{ route('order') }}" class="ai-icon" aria-expanded="false">
                            ...
                            <span class="nav-text">Order
                                <div id="order_status" class="badge bg-danger badge-md text-white">{{ \App\Models\Order_summary::where('delivery_status', 'pending')->count() }}</div>
                            </span>
                        </a>
                    </li>
...
***********************************-->
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Developed by <a href="{{ route('home') }}" target="_blank">MokaromPranto</a> {{ \Carbon\Carbon::now()->format('Y') }}</p>
            </div>
        </div>
        <!--**********************************
            Footer end												</div>
    ...
    ***********************************-->
	...
	<script src="{{ asset('dashboard') }}/vendor/datatables/js/jquery.dataTables.min.js" rel="stylesheet"></script>
	...
	<script>
		...
		jQuery(window).on('load',function(){
            ...
            function doThis() {
                ...
                $( "#order_status" ).load(window.location.href + " #order_status" );
            };
		});
